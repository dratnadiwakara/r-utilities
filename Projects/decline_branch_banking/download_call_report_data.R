...
#DEPDOM,DEPFOR,EQ2, EQ,LNLSGR,NIM,INTINC,NONII,
# DEPUNA,NETINC,DEPLGA,DEPUNAC,DEPSMA,
# AVDITRAN,LNCIDOM,
# EINTEXP,EDEPFOR,EFREPP,ETTLOTBO,ESUBND
  ...
  repeat {
    req_q <- request("https://api.fdic.gov/banks/financials") |>
      req_url_query(
        ...
        fields    = "RSSDHCR,RSSDID,CERT,REPDTE,ASSET,AVDITRAN",  # total assets is ASSET
        limit     = limit,
        offset    = offset
      )
...
years <- 2025
t <- get_financials_quarter("20250331")
