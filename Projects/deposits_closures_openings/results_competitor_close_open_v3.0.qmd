...
setFixest_fml(
  ...
  ..vcov      = ~ UNINUMBR,
  ..fml_baseline = ~competitor_closures_rate +  log1p(DEPSUMBR) ,
  ..fml_baseline2 = ~competitor_close_dep_share_prev+ +  log1p(DEPSUMBR),
  ..fml_interaction = ~competitor_closures_rate*sophisticated_ed_sm + log1p(DEPSUMBR),
  ..fml_interaction2 = ~competitor_close_dep_share_prev*sophisticated_ed_sm  + log1p(DEPSUMBR)
)
