...
```{r}
dt <- readRDS("C:/data/zip_competition_churn_panel_Nov24_v6.rds")
setDT(dt)
...
setFixest_fml(
  ...
  ..vcov      = ~ ZIPBR,
  ..controls = ~ +log1p(deps_lag1)+incumbent_mkt_share_lag1+closer_remaining_mkt_share_lag1+ log1p(branches_zip_lag1),#+incumbent_mkt_share_lag1+zip_dep_growth_t4_t1+log1p(deps_lag1)+closer_remaining_mkt_share_lag1,
...
```{r}
r <- list()
r[[1]] <- feols(gr_3y~..fml_baseline_amt | ..fixef_y_z_cbsayr,data=dt[incumbent_mkt_share_lag1>0.2 ],vcov=~ZIPBR)
r[[2]] <- feols(gr_3y~..fml_baseline_amt | ..fixef_y_z_cntyyr,data=dt[incumbent_mkt_share_lag1>0.2],vcov=~ZIPBR)
r[[3]] <- feols(gr_3y_cd~..fml_baseline_amt | ..fixef_y_z_cbsayr,data=dt[incumbent_mkt_share_lag1>0.2 ],vcov=~ZIPBR)
r[[4]] <- feols(gr_3y_cd~..fml_baseline_amt | ..fixef_y_z_cntyyr,data=dt[incumbent_mkt_share_lag1>0.2],vcov=~ZIPBR)
r[[5]] <- feols(gr_3y_cln_cd~..fml_baseline_amt | ..fixef_y_z_cbsayr,data=dt[incumbent_mkt_share_lag1>0.2 ],vcov=~ZIPBR)
r[[6]] <- feols(gr_3y_cln_cd~..fml_baseline_amt | ..fixef_y_z_cntyyr,data=dt[incumbent_mkt_share_lag1>0.2],vcov=~ZIPBR)
...
```{r}
r <- list()
r[[1]] <- feols(gr_3y~..fml_interactions_amt | ..fixef_y_z_cbsayr,data=dt[incumbent_mkt_share_lag1>0.2 ],vcov=~ZIPBR)
r[[2]] <- feols(gr_3y~..fml_interactions_amt | ..fixef_y_z_cntyyr,data=dt[incumbent_mkt_share_lag1>0.2],vcov=~ZIPBR)
r[[3]] <- feols(gr_3y_cd~..fml_interactions_amt | ..fixef_y_z_cbsayr,data=dt[incumbent_mkt_share_lag1>0.2 ],vcov=~ZIPBR)
r[[4]] <- feols(gr_3y_cd~..fml_interactions_amt | ..fixef_y_z_cntyyr,data=dt[incumbent_mkt_share_lag1>0.2],vcov=~ZIPBR)
r[[5]] <- feols(gr_3y_cln_cd~..fml_interactions_amt | ..fixef_y_z_cbsayr,data=dt[incumbent_mkt_share_lag1>0.2 ],vcov=~ZIPBR)
r[[6]] <- feols(gr_3y_cln_cd~..fml_interactions_amt | ..fixef_y_z_cntyyr,data=dt[incumbent_mkt_share_lag1>0.2],vcov=~ZIPBR)
md_table(etable(r,signif.code =  c("***"=0.01, "**"=0.05, "*"=0.10)))
...
```{r}
r <- list()
r[[1]] <- feols(gr_3y~..fml_interaction_amt | ..fixef_y_z_cbsayr,data=dt[YEAR %in% 2000:2011],vcov=~ZIPBR)
r[[2]] <- feols(gr_3y_cd~..fml_interactions_amt | ..fixef_y_z_cbsayr,data=dt[YEAR %in% 2000:2011],vcov=~ZIPBR)
r[[3]] <- feols(gr_3y_cln_cd~..fml_interactions_amt | ..fixef_y_z_cbsayr,data=dt[YEAR %in% 2000:2011],vcov=~ZIPBR)
r[[4]] <- feols(gr_3y~..fml_interaction_amt | ..fixef_y_z_cbsayr,data=dt[YEAR %in% 2012:2024],vcov=~ZIPBR)
r[[5]] <- feols(gr_3y_cd~..fml_interactions_amt | ..fixef_y_z_cbsayr,data=dt[YEAR %in% 2012:2024],vcov=~ZIPBR)
r[[6]] <- feols(gr_3y_cln_cd~..fml_interactions_amt | ..fixef_y_z_cbsayr,data=dt[YEAR %in% 2012:2024],vcov=~ZIPBR)
r[[7]] <- feols(gr_3y~..fml_interaction_amt | ..fixef_y_z_cbsayr,data=dt,vcov=~ZIPBR)
r[[8]] <- feols(gr_3y_cd~..fml_interactions_amt | ..fixef_y_z_cbsayr,data=dt,vcov=~ZIPBR)
r[[9]] <- feols(gr_3y_cln_cd~..fml_interactions_amt | ..fixef_y_z_cbsayr,data=dt,vcov=~ZIPBR)
...
md_table(etable(r,signif.code =  c("***"=0.01, "**"=0.05, "*"=0.10),
                 headers= c("2000:2011","2000:2011","2000:2011","2012:2024","2012:2024","2012:2024",rep("All",3))))
...
```{r}
r <- list()
r[[1]] <- feols(gr_3y~..fml_interaction_amt | ..fixef_y_z_cbsayr,data=dt[incumbent_mkt_share_lag1>0.25 ],vcov=~ZIPBR)
r[[2]] <- feols(gr_3y~..fml_interactions_amt | ..fixef_y_z_cbsayr,data=dt[incumbent_mkt_share_lag1>0.25 ],vcov=~ZIPBR)
r[[3]] <- feols(gr_3y~..fml_interaction_amt | ..fixef_y_z_cntyyr,data=dt[incumbent_mkt_share_lag1>0.25 ],vcov=~ZIPBR)
r[[4]] <- feols(gr_3y~..fml_interactions_amt | ..fixef_y_z_cntyyr,data=dt[incumbent_mkt_share_lag1>0.25 ],vcov=~ZIPBR)
...
r <- list()
r[[1]] <- feols(gr_3y~..fml_interaction_amt | ..fixef_y_z_cbsayr,data=dt[YEAR %in% 2000:2011],vcov=~ZIPBR)
r[[2]] <- feols(gr_3y~..fml_interactions_amt | ..fixef_y_z_cbsayr,data=dt[YEAR %in% 2000:2011],vcov=~ZIPBR)
r[[3]] <- feols(gr_3y~..fml_interaction_amt | ..fixef_y_z_cbsayr,data=dt[YEAR %in% 2012:2024],vcov=~ZIPBR)
r[[4]] <- feols(gr_3y~..fml_interactions_amt | ..fixef_y_z_cbsayr,data=dt[YEAR %in% 2012:2024],vcov=~ZIPBR)
# r[[3]] <- feols(gr_3y~..fml_interactions_amt | ..fixef_y_z_cbsayr,data=dt[YEAR %in% 2012:2019],vcov=~ZIPBR)
# r[[4]] <- feols(gr_3y~..fml_interactions_amt | ..fixef_y_z_cbsayr,data=dt[YEAR %in% 2020:2024],vcov=~ZIPBR)

md_table(etable(r,signif.code =  c("***"=0.01, "**"=0.05, "*"=0.10),
                 headers= c("2000:2011","2000:2011","2012:2024","2012:2024")))
...
```{r}
# r <- list()
# r[[1]] <- feols(incumbent_growth_share_3yr_pp~share_deps_closed_pp+log(population_filled)+log1p(n_incumbent_banks)|YEAR+ZIPBR,data=dt,vcov=~ZIPBR)
# r[[2]] <- feols(incumbent_growth_share_3yr_own_deposits~share_deps_closed+log(population_filled)+log1p(n_incumbent_banks)|YEAR+ZIPBR,data=dt,vcov=~ZIPBR)
# r[[3]] <- feols(incumbent_growth_share_3yr~share_deps_closed+log(population_filled)+log1p(n_incumbent_banks)|YEAR+ZIPBR,data=dt,vcov=~ZIPBR)
# 
# etable(r)
```
...
```{r}
vars_of_interest <- c(
  "incumbent_growth_share_3yr_own_deposits",   # Dependent Var (Long term)
