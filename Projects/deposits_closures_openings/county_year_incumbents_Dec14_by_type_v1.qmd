...
dt <- readRDS("C:/data/county_competition_panel_by_type_Dec14_v2.rds")
setDT(dt)


dt <- dt[branches_lag1>=3]

winsor_vars <- grep("^gr_", names(dt), value = TRUE)
...
setFixest_fml(
  ...
  ..interactions = ~share_cl_large*sophisticated + share_cl_large*above_median_age + share_cl_large*above_median_income,
  ..vcov      = ~ county,
  ..controls = ~ + log1p(branches_lag1)+county_dep_growth_t4_t1 + share_rem_large    +log1p(deps_lag1) #+incumbent_mkt_share_lag1+zip_dep_growth_t4_t1+log1p(deps_lag1)+closer_remaining_mkt_share_lag1,+zip_dep_growth_t4_t1
)
...
```{r}
temp <- summary_stats_function(dt[YEAR==2019 & share_cl_large>0],vars)
...
r[[1]] <- feols(gr_3y_large~share_cl_large+..controls | ..fixef_y_z_stateyr,data=dt)
r[[2]] <- feols(gr_3y_cd_large~share_cl_large+..controls  | ..fixef_y_z_stateyr,data=dt)
# r[[3]] <- feols(gr_3y_cd_large_lag~share_cl_large+..controls  | ..fixef_y_z_stateyr,data=dt)
r[[3]] <- feols(gr_1y_cd_large~share_cl_large+..controls  | ..fixef_y_z_stateyr,data=dt)
# r[[5]] <- feols(gr_1y_cd_large_lag~share_cl_large+..controls  | ..fixef_y_z_stateyr,data=dt)
...
r[[1]] <- feols(gr_3y_large~..interactions+..controls | ..fixef_y_z_stateyr,data=dt)
r[[2]] <- feols(gr_3y_cd_large~..interactions+..controls  | ..fixef_y_z_stateyr,data=dt)
# r[[3]] <- feols(gr_3y_cd_lag~..interactions+..controls  | ..fixef_y_z_stateyr,data=dt)
r[[3]] <- feols(gr_1y_cd_large~..interactions+..controls  | ..fixef_y_z_stateyr,data=dt)
...
r[[1]] <- feols(gr_3y_cd_large~..interactions+..controls  | ..fixef_y_z_stateyr,data=dt[YEAR<=2011])
r[[2]] <- feols(gr_3y_cd_large~..interactions+..controls  | ..fixef_y_z_stateyr,data=dt[YEAR>=2012])
...
r[[3]] <- feols(gr_1y_cd_large~..interactions+..controls  | ..fixef_y_z_stateyr,data=dt[YEAR<=2011])
r[[4]] <- feols(gr_1y_cd_large~..interactions+..controls  | ..fixef_y_z_stateyr,data=dt[YEAR>=2012])
