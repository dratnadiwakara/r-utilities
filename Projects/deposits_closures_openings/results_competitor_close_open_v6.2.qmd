...
```{r}
dt <- readRDS("C:/data/zip_competition_churn_panel_refined_3.rds")
setDT(dt)
...
g2 <- ggplot(dt[ YEAR==2019], aes(x = incumbent_dep_gr_3yr)) +
...
g3 <- ggplot(dt[ YEAR==2019], aes(x = incumbent_growth_share_3yr)) +
...
```{r}
summary(dt$incumbent_dep_gr_3yr)
summary(dt$incumbent_growth_share_3yr)
```
...
```{r}
dt[,pos_share:=ifelse(share_deps_closed>0,1,0)]
```

```{r}
r <- feols(incumbent_growth_share_3yr~pos_share|ZIPBR+YEAR+county_yr,data=dt)
...
```{r}
r <- list()
r[[1]] <- feols(incumbent_growth_share_3yr~..fml_baseline_amt | ..fixef_y_z_cbsayr,data=dt[share_deps_closed<0.1],vcov=~ZIPBR)
r[[2]] <- feols(incumbent_growth_share_3yr~..fml_baseline_amt  | ..fixef_y_z_cbsayr,data=dt[share_deps_closed<0.1],vcov=~ZIPBR)
r[[3]] <- feols(incumbent_growth_share_3yr~..fml_baseline_amt  | ..fixef_cbsayr,data=dt[share_deps_closed<0.1],vcov=~ZIPBR)
r[[4]] <- feols(incumbent_growth_share_3yr~..fml_baseline_amt  | ..fixef_y_z_cntyyr,data=dt[share_deps_closed<0.1],vcov=~ZIPBR)
...
r[[2]] <- feols(incumbent_growth_share_3yr_alt2~..fml_baseline_amt  | ..fixef_y_z_cbsayr,data=dt,vcov=~ZIPBR)
r[[3]] <- feols(incumbent_growth_share_3yr~..fml_baseline_amt  | ..fixef_cbsayr,data=dt,vcov=~ZIPBR)
r[[4]] <- feols(incumbent_growth_share_3yr~..fml_baseline_amt  | ..fixef_y_z_cntyyr,data=dt,vcov=~ZIPBR)
# r[[5]] <- feols(incumbent_growth_share_3yr~..fml_baseline_no  | ..fixef_y_z_cbsayr ,data=dt,vcov=~ZIPBR)
...
```{r}
r <- list()
r[[1]] <- feols(incumbent_growth_share_3yr_alt~..fml_interaction_amt | ..fixef_y_z_cbsayr,data=dt,vcov=~ZIPBR)
r[[2]] <- feols(incumbent_growth_share_3yr_alt~..fml_interactions_amt | ..fixef_y_z_cbsayr,data=dt,vcov=~ZIPBR)
r[[3]] <- feols(incumbent_growth_share_3yr_alt~..fml_interaction_amt | ..fixef_y_z_cbsayr,data=dt,vcov=~ZIPBR)
r[[4]] <- feols(incumbent_growth_share_3yr_alt~..fml_interactions_amt | ..fixef_y_z_cbsayr,data=dt,vcov=~ZIPBR)
...
```{r}
r <- list()
r[[1]] <- feols(incumbent_growth_share_3yr_alt~..fml_interactions_amt | ..fixef_cbsayr,data=dt[YEAR %in% 2000:2007],vcov=~ZIPBR)
r[[2]] <- feols(incumbent_growth_share_3yr_alt~..fml_interactions_amt | ..fixef_cbsayr,data=dt[YEAR %in% 2008:2011],vcov=~ZIPBR)
r[[3]] <- feols(incumbent_growth_share_3yr_alt~..fml_interactions_amt | ..fixef_cbsayr,data=dt[YEAR %in% 2012:2019],vcov=~ZIPBR)
r[[4]] <- feols(incumbent_growth_share_3yr_alt~..fml_interactions_amt | ..fixef_cbsayr,data=dt[YEAR %in% 2020:2024],vcov=~ZIPBR)
