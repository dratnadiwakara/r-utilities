...
r[[7]] <- feols(delta_DEPDOM_assets_w~share_sophisticated_closed_last3+share_non_sophisiticated_closed_last3+frac_opened_last3+..ctrl_basic|YEAR,data=df,vcov = ~RSSDID)
r[[8]] <- feols(delta_DEPDOM_assets_w~share_sophisticated_closed_last3+share_non_sophisiticated_closed_last3+frac_opened_last3+..ctrl_basic|RSSDID+YEAR,data=df,vcov = ~RSSDID)
