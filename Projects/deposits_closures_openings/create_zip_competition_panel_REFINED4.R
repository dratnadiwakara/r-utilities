...
output_path <- "C:/data/zip_competition_churn_panel_refined_6.rds"
...
# Clean up
zip_market_stats[, c("zip_growth", "lag_YEAR", "deposits_per_closed_br", "deposits_per_branch", "deposits_closed_tot") := NULL]
