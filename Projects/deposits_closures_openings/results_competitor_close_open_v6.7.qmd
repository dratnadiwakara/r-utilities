...
dt[, small_shock := total_closed_vol_zip_lag1 < 25000]
...
r[[5]] <- feols(gr_3yr~share_deps_closed+log1p(branches_zip_lag1)|ZIPBR+cbsa_yr,data=dt[total_closed_vol_zip_lag1<25000])
...
r <- list()
r[[1]] <- feols(gr_3yr~share_deps_closed*sophisticated_ed_sm+log1p(branches_zip_lag1)|ZIPBR+cbsa_yr,data=dt)
r[[2]] <- feols(gr_3yr~share_deps_closed*sophisticated_ed_sm+log1p(branches_zip_lag1)+small_shock|ZIPBR+cbsa_yr,data=dt)
r[[3]] <- feols(gr_3yr~share_closed_small*sophisticated_ed_sm+share_closed_large*sophisticated_ed_sm+log1p(branches_zip_lag1)|ZIPBR+cbsa_yr,data=dt)
r[[4]] <- feols(gr_3yr~share_deps_closed*sophisticated_ed_sm+log1p(branches_zip_lag1)+log1p(total_closed_vol_zip_lag1) |ZIPBR+cbsa_yr,data=dt)
r[[5]] <- feols(gr_3yr~share_deps_closed*sophisticated_ed_sm+log1p(branches_zip_lag1)|ZIPBR+cbsa_yr,data=dt[total_closed_vol_zip_lag1<25000])
...
r <- list()
r[[1]] <- feols(gr_3yr~share_deps_closed*sophisticated_ed_sm+log1p(branches_zip_lag1)|ZIPBR+cbsa_yr,data=dt[YEAR %in% 2000:2007])
r[[2]] <- feols(gr_3yr~share_deps_closed*sophisticated_ed_sm+log1p(branches_zip_lag1)+small_shock|ZIPBR+cbsa_yr,data=dt[YEAR %in% 2000:2007])
r[[3]] <- feols(gr_3yr~share_closed_small*sophisticated_ed_sm+share_closed_large*sophisticated_ed_sm+log1p(branches_zip_lag1)|ZIPBR+cbsa_yr,data=dt[YEAR %in% 2000:2007])
r[[4]] <- feols(gr_3yr~share_deps_closed*sophisticated_ed_sm+log1p(branches_zip_lag1)+log1p(total_closed_vol_zip_lag1) |ZIPBR+cbsa_yr,data=dt[YEAR %in% 2000:2007])
r[[5]] <- feols(gr_3yr~share_deps_closed*sophisticated_ed_sm+log1p(branches_zip_lag1)|ZIPBR+cbsa_yr,data=dt[total_closed_vol_zip_lag1<25000& YEAR %in% 2000:2007])
...
r <- list()
r[[1]] <- feols(gr_3yr~share_deps_closed*sophisticated_ed_sm+log1p(branches_zip_lag1)|ZIPBR+cbsa_yr,data=dt[YEAR >2011])
r[[2]] <- feols(gr_3yr~share_deps_closed*sophisticated_ed_sm+log1p(branches_zip_lag1)+small_shock|ZIPBR+cbsa_yr,data=dt[YEAR >2011])
r[[3]] <- feols(gr_3yr~share_closed_small*sophisticated_ed_sm+share_closed_large*sophisticated_ed_sm+log1p(branches_zip_lag1)|ZIPBR+cbsa_yr,data=dt[YEAR >2011])
r[[4]] <- feols(gr_3yr~share_deps_closed*sophisticated_ed_sm+log1p(branches_zip_lag1)+log1p(total_closed_vol_zip_lag1) |ZIPBR+cbsa_yr,data=dt[YEAR >2011])
r[[5]] <- feols(gr_3yr~share_deps_closed*sophisticated_ed_sm+log1p(branches_zip_lag1)|ZIPBR+cbsa_yr,data=dt[total_closed_vol_zip_lag1<25000& YEAR >2011])
