...
```{r}
dt <- readRDS("C:/data/zip_competition_churn_panel_Dec04_v1.rds")
setDT(dt)
...
dt[,incumbent_dep_gr_3yr_lag1:=Winsorize(incumbent_dep_gr_3yr_lag1, val = quantile(incumbent_dep_gr_3yr_lag1, probs = c(0.01, 0.99), na.rm = T)),by=YEAR]
# dt[,incumbent_dep_gr_3yr_clean:=Winsorize(incumbent_dep_gr_3yr_clean, val = quantile(incumbent_dep_gr_3yr_clean, probs = c(0.01, 0.99), na.rm = T)),by=YEAR]
dt[,incumbent_dep_gr_3yr_cd_lag:=Winsorize(incumbent_dep_gr_3yr_cd_lag, val = quantile(incumbent_dep_gr_3yr_cd_lag, probs = c(0.01, 0.99), na.rm = T)),by=YEAR]
dt[,incumbent_dep_gr_1yr_cd_lag:=Winsorize(incumbent_dep_gr_1yr_cd_lag, val = quantile(incumbent_dep_gr_1yr_cd_lag, probs = c(0.01, 0.99), na.rm = T)),by=YEAR]
# 
...
dt[,gr_3y_lag:= incumbent_dep_gr_3yr_lag1]
...
```{r}
r <- list()
r[[1]] <- feols(gr_3y_lag~share_deps_closed+..controls | ..fixef_y_z_cbsayr,data=dt[incumbent_mkt_share_lag1>0.25 ],vcov=~ZIPBR)
r[[2]] <- feols(gr_3y_lag~share_deps_closed+..controls  | ..fixef_y_z_cntyyr,data=dt[incumbent_mkt_share_lag1>0.25],vcov=~ZIPBR)
r[[3]] <- feols(gr_3y_cd_lag~share_deps_closed+..controls  | ..fixef_y_z_cbsayr,data=dt[incumbent_mkt_share_lag1>0.25 ],vcov=~ZIPBR)
r[[4]] <- feols(gr_3y_cd_lag~share_deps_closed+..controls| ..fixef_y_z_cntyyr,data=dt[incumbent_mkt_share_lag1>0.25],vcov=~ZIPBR)
r[[5]] <- feols(gr_1y_cd_lag~share_deps_closed+..controls  | ..fixef_y_z_cbsayr,data=dt[incumbent_mkt_share_lag1>0.25 ],vcov=~ZIPBR)
...
```{r}
r <- list()
r[[1]] <- feols(gr_3y_cd_lag~share_deps_closed*sophisticated+share_deps_closed*above_median_age+share_deps_closed*above_median_income+..controls  | ..fixef_y_z_cbsayr,data=dt[incumbent_mkt_share_lag1>0.25 & YEAR<=2011],vcov=~ZIPBR)
r[[2]] <- feols(gr_3y_cd_lag~share_deps_closed*sophisticated+share_deps_closed*above_median_age+share_deps_closed*above_median_income+..controls  | ..fixef_y_z_cbsayr,data=dt[incumbent_mkt_share_lag1>0.25 & YEAR>=2012],vcov=~ZIPBR)
r[[3]] <- feols(gr_3y_cd_lag~share_deps_closed*w_drop_visits+..controls  | ..fixef_y_z_cbsayr,data=dt[incumbent_mkt_share_lag1>0.25 & YEAR>=2018],vcov=~ZIPBR)
md_table(etable(r,signif.code =  c("***"=0.01, "**"=0.05, "*"=0.10)))
